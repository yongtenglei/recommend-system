...
tf.app.flags.DEFINE_integer('negative_num', 1, 'number of negative samples.')
tf.app.flags.DEFINE_integer('test_neg', 50, 'number of negative samples for test.')
tf.app.flags.DEFINE_integer('embedding_size', 8, 'the size for embedding user and item.')
tf.app.flags.DEFINE_integer('epochs', 1, 'the number of epochs.')
...
def main():
    ((train_features, train_labels),
     ...
     (user_size, item_size),
     (user_negative)) = NCF_input.load_data()
